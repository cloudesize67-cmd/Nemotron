...
| [AlphaEvolve-Style Evolutionary Pipeline for the BMV Protocol](alphaevolve-bmv-protocol/README.md) | AlphaEvolve/FunSearch-style evolutionary coding pipeline that uses a Nemotron model as the LLM actor and a SymPy-based physics evaluator to evolve a solver for the Bose-Marletto-Vedral quantum-gravity witness protocol. |
